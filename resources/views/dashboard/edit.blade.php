...
<div class="d">
<h1 class="text-5xl font-bold text-gray-500">Edit Materi</h1>  
</div>
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form method="POST" action="/edit-materi/{{$instrument->slug}}">
                   @method('put')
                    @csrf
                    @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="name" id="name" name="name" class="border-2 border-gray-300 p-2 w-full" name="name" id="name" value="{{old('name', $instrument->name)}}"  required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="slug" name="slug" id="slug" class="border-2 border-gray-300 p-2 w-full" placeholder="hurufkecilsemuadarititle" value="{{old('slug', $instrument->slug)}}" required>
                    </div>
                    ...
                    <label class="text-xl text-gray-600">Category</label></br>
                     <select id="category_id" name="category_id" required class="border-2 border-gray-300 border-r p-2">
