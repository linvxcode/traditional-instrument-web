...
<h1 class="text-5xl font-bold text-gray-500"> progress</h1>
...
<h1 class="text-5xl font-bold text-gray-500">Welcome Back, {{auth()->user()->username}} </h1>
{{-- <h1 class="text-2xl mt-2 font-bold text-gray-500">My Post</h1> --}}
    ...
    <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
      <div class="overflow-hidden">
        <table class="min-w-full">
          ...
          <tbody>
            @foreach ($instrumentss as $instrument)
...
{{-- <div class="d">
  <div class="flex flex-col">
    <div class="overflow-x-auto sm:mx-0.5 lg:mx-0.5">
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
      <h1 class="text-2xl font-bold text-gray-500">Songs</h1>
      <div class="overflow-hidden">
        <table class="min-w-full">
          <thead class=" border-b">
            <tr>
          ...
          <tbody>
            <tr class="bg-gray-100 border-b">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{$loop->iteration}}</td>
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{$songs->name}}</td>
