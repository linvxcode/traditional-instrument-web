...
{{-- <h1r class="container">------------ Serunee Kalee ----------</h1r> --}}
    <div class="flex justify-center justify-items-center px-5 h-auto" id="key">
        ...
        <!-- white keys -->
        <div data-note="A" class="key white" ><h3 class="tuts">A</h3></div>
        ...
        <!-- Audio files -->
       <audio id="C" src="music/geundrang/tom1-gdr.wav"></audio>
       <audio id="D" src="music/geundrang/tom2-gdr.wav"></audio>
       <audio id="E" src="music/geundrang/rim-gdr.wav"></audio>
       <audio id="F" src="music/geundrang/tom3-gdr.wav"></audio>
...
const WHITE= ['a','s','d','f','g','h'];
// const BLACK=['r','t','y','u','i'];

const WHITEE= ['A','S','D','F','G','H'];
